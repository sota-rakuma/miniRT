...
unsigned char Color::getTransparency(void) { return (((unsigned char*)&_trgb)[3]); }
...
void	Color::setTransparency(unsigned char t)
{
	((unsigned char *)_trgb)[3] = t;
}
void	Color::setRed(unsigned char r)
{
	((unsigned char *)_trgb)[2] = r;
}

void	Color::setGreen(unsigned char g)
{
	((unsigned char *)_trgb)[1] = g;
}

void	Color::setBlue(unsigned char b)
{
	((unsigned char *)_trgb)[0] = b;
}
